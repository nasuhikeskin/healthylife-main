...
import 'package:diyetin_app/services/data_base.dart';
...
class FirestoreDBService implements DBBase {
  ...
  Future<MyUser> getDiyetisyen(String userID) async {
    ...
    await _firebaseDB
        ...
        .get()
        .then((querySnapshots) {
      diyetisyen = querySnapshots.data()['diyetisyen'].toString();
    });
    ...
    await _firebaseDB
      ...
      _diyetisyen = MyUser(
        userID: diyetisyen,
        email: querySnapshots.data()['email'],
        userName: querySnapshots.data()['userName'],
        profilURL: querySnapshots.data()['profilURL'],
        seviye: querySnapshots.data()['seviye'],
      );
    });
    return _diyetisyen;
  }
